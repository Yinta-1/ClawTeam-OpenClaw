...
STOP_WORDS = frozenset({
    ...
    "which", "who", "whom", "about", "up", "down", "go", "get", "do",
    "make", "take", "come", "let", "say", "goes", "went", "gone", "going",
    # Chinese
    "的", "了", "在", "是", "我", "有", "和", "与", "或", "不", "也",
    "就", "都", "而", "及", "已", "至", "者", "之", "其", "这", "那",
    "但", "还", "因", "并", "或", "对", "于", "以", "被", "从", "上",
    "下", "中", "等", "把", "让", "向", "往", "所", "若", "如", "此",
    "该", "它", "们", "个", "么", "吗", "呢", "啊", "呀", "哦", "嗯",
    "吧", "嘛", "啦",
})
