...
class RedisTransport(Transport):
    ...
    def _connect(self) -> None:
        ...
        try:
            ...
            raise ImportError("Redis transport requires 'redis' package. Install with: pip install agentteam[redis]")
    ...
    def list_recipients(self) -> list[str]:
        ...
        while True:
            ...
            for key in keys:
                # Extract agent name from key: agentteam:team:inbox:agent
