"""CLI commands for agentteam - framework-agnostic multi-agent coordination."""
...
from agentteam.team.models import _now_iso
...
def main(
    ...
    data_dir: Optional[str] = typer.Option(
        None,
        "--data-dir",
        help="Override data directory (default: ~/.agentteam).",
    ),
...
def doctor_fix(
    ...
    if cleanup or all_fixes:
        ...
        try:
            from agentteam.spawn.registry import list_dead_agents, terminate_agent_tree
...
def config_init(
    ...
    """Create a default configuration file in ~/.agentteam/config.yaml."""
    from pathlib import Path
    import yaml
...
def template_list():
    ...
    def _human(data):
        ...
        console.print(table)
        console.print("\n[dim]Run `agentteam template show <name>` for details.[/dim]")
...
def runtime_state(
    ...
    from agentteam.team.routing_policy import DefaultRoutingPolicy
...
def task_wait(
    ...
    from agentteam.team.manager import TeamManager
    from agentteam.team.tasks import TaskStore
    from agentteam.team.waiter import TaskWaiter
...
def lifecycle_on_exit(
    ...
    from agentteam.team.manager import TeamManager
    from agentteam.team.models import TaskStatus
    from agentteam.team.parent_child import ParentChildRegistry
    from agentteam.team.tasks import TaskStore
    ...
    # ~/.agentteam/sessions/{team}/ after every agent exit.
...
def lifecycle_check_zombies(
    ...
    """
    from agentteam.spawn.registry import list_zombie_agents
    ...
    def _fmt(d: dict) -> None:
        ...
        console.print(
            ...
            "Inspect them manually or run: agentteam lifecycle stop-agent --team <team> --agent <name>[/dim]"
        )
    ...
    if not cascade:
        ...
        for child in children:
            ...
            if alive is True and not force:
                ...
                continue
            try:
                from agentteam.spawn.registry import terminate_agent_tree
...
def spawn_agent(
    ...
    # Build prompt: identity + task + agentteam coordination guide
    prompt = None
    if task:
        import os as _os
...
def identity_set(
    ...
    if _json_output:
        ...
        console.print(f"\nOr use: eval $(agentteam identity set {' '.join(sys.argv[3:])})")
...
def board_monitor(
    ...
    Requires the board server to be running (`agentteam board serve`).
    """
    import urllib.request
    import urllib.parse
    import datetime
...
def board_serve(
    ...
    from agentteam.board.server import serve
...
def workspace_status(
    ...
    from agentteam.workspace import get_workspace_manager, git
...
def launch_team(
    ...
    from agentteam.team.manager import TeamManager
    from agentteam.team.tasks import TaskStore
    from agentteam.templates import TemplateDef, load_template, render_task
    ...
    if not force:
        from agentteam.templates import check_agent_count
    ...
    from agentteam.config import load_config as _load_config
...
def drift_check(
    ...
    from agentteam.store.file import FileTaskStore
    from agentteam.team.drift import check_task_drift
...
def alert_check(
    ...
    from agentteam.alerts import check_all_alerts
...
def alert_list(
    ...
    from agentteam.alerts import AlertSeverity, AlertType, list_alerts
...
def alert_acknowledge(
    ...
    from agentteam.alerts import acknowledge_alert, get_alert
...
def alert_config(
    ...
    from agentteam.alerts import get_alert_config, save_alert_config
...
def alert_check(
    ...
    """
    from agentteam.alerts import check_agent_failure_rates, check_task_timeouts
    ...
    def _human(_data):
        ...
        if total_alerts > 0:
            console.print("[yellow]* New alerts have been created. Use 'agentteam alert list' to view them.[/yellow]")
        else:
...
def alert_list(
    ...
    from agentteam.alerts import list_alerts
...
def alert_ack(
    ...
    """Acknowledge an alert."""
    from agentteam.alerts import acknowledge_alert
    from agentteam.identity import AgentIdentity
...
def audit_query(
    ...
    from agentteam.audit import read_audit_log
...
def audit_summary(
    ...
    from agentteam.audit import get_audit_summary
...
def dag_sort(
    ...
    from agentteam.team.dag import CycleDetectedError, topological_sort
    from agentteam.team.tasks import TaskStore
...
def dag_check(
    ...
    from agentteam.team.dag import detect_cycle
    from agentteam.team.tasks import TaskStore
...
def dag_ready(
    ...
    from agentteam.team.dag import get_ready_tasks
    from agentteam.team.tasks import TaskStore
    ...
    def _human(_data):
        if not ready:
            ...
            from agentteam.team.dag import get_blocking_tasks
...
def role_assign(
    ...
    from agentteam.team.roles import AgentRole, assign_role
...
def role_unassign(
    ...
    from agentteam.team.roles import AgentRole, unassign_role
...
def role_list(
    ...
    from agentteam.team.roles import get_all_assignments
...
def role_suggest(
    ...
    from agentteam.team.roles import suggest_role
    from agentteam.team.tasks import TaskStore
...
from agentteam.cli.session import session_app
from agentteam.cli.daemon_cmd import daemon_app
...
def agent_list_types():
    ...
    from agentteam.spawn.agent_config import list_agent_types
...
def agent_info(
    ...
    from agentteam.spawn.registry import get_agent_info, is_agent_alive, get_agent_health
...
def agent_restart(
    ...
    from agentteam.spawn.registry import get_agent_info, is_agent_alive, unregister_agent
    from agentteam.spawn import get_backend
    import subprocess
    import json
