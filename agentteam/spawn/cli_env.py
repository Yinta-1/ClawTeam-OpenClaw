"""Helpers for making the current agentteam executable available to spawned agents."""
...
def resolve_agentteam_executable() -> str:
    ...
    install via an absolute path. Fall back to `shutil.which("agentteam")`, then
    ...
    resolved = shutil.which("agentteam")
    return resolved or "agentteam"
