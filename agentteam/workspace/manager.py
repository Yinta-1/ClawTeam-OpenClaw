...
from agentteam.workspace import git
from agentteam.workspace.models import WorkspaceInfo, WorkspaceRegistry
...
class WorkspaceManager:
    ...
    def checkpoint(
        ...
        msg = message or f"[agentteam] checkpoint: {agent_name} @ {ts}"
    ...
    def cleanup_workspace(
        ...
        if auto_checkpoint:
            try:
                self.checkpoint(team_name, agent_name, f"[agentteam] final checkpoint: {agent_name}")
            except Exception:
                pass
    ...
    def merge_workspace(
        ...
        self.checkpoint(team_name, agent_name, f"[agentteam] pre-merge checkpoint: {agent_name}")
